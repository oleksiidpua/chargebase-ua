    ...
    >
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-8 lg:px-8">
        <div className="flex flex-col justify-center">
          ...
          <div className="mb-6 inline-flex w-fit items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-4 py-1.5 text-xs font-medium text-emerald-300">
            <Sparkles size={14} />
            {t('badge')}
          </div>
        ...
        <div className="relative flex items-center justify-center">
          <div className="relative aspect-square w-full max-w-lg">
            <div
              aria-hidden
              className="hero-glow absolute inset-0 rounded-full bg-emerald-500/20 blur-3xl"
            />
